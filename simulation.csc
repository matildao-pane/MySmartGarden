...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype219</identifier>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/AIoTProject/gate/node-gate.c</source>
      <commands>make node-gate.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/AIoTProject/irrigator/node-irrigator.c</source>
      <commands>make node-irrigator.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>93.75142244258906</x>
        <y>59.406055451258446</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype219</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>74.95757902259936</x>
        <y>51.90356071841991</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>96.50787815137053</x>
        <y>30.28944584964005</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.813263709587654 0.0 0.0 4.813263709587654 -94.15423123166268 -79.36405066244346</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
